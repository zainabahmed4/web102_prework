...
* [x] Game cards include images, names, descriptions, and backer counts.
...
Video created with macOS screen recording.  
<!-- Recommended tools:
...
One challenge was connecting the filter buttons to the correct event handlers and making sure old game cards were removed before displaying the filtered results.
